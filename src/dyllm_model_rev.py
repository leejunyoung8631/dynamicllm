...
from attn import DyLLAMA_ATTENTION_CLASSES, DyDynamicCache
...
class DyLlamaDecoderLayer(LlamaDecoderLayer):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Added : After residual only the last token will be passed 
        # 위에서 앞에 붙어서 attention 했다면 아래 연산을 해줘야함.
