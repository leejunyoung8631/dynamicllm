...
class Predictor(nn.Module):
    def __init__(self, config):
        ...
        self.predictor = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(512, 1)  # Example output classes
        )
...
class CustomLlamaModel(LlamaModel):
    ...
    def forward(
        ...
        for n_layer, decoder_layer in enumerate(self.layers):
            if output_hidden_states and n_layer in g_layer:
        ...
        if output_hidden_states and 32 in g_layer:
            all_hidden_states += (hidden_states,)
...
class CustomLlamaForCausalLM(LlamaForCausalLM):
    def __init__(self, config, ):
        ...
        # in modeling_utils, => @property loss_function
