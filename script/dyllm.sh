...
CUDA_VISIBLE_DEVICES=1 python dyllm.py \
                    ...
                    --data_path wikitext \
                    --learning_rate 1e-4 --batch_size 64 --micro_batch_size 8 \
                    --output_dir ./data/ljy_data/dyllm_test_21 \
                    --num_epochs 3 --loss_term mask,ppl \
...
#                     --num_epochs 10 --loss_term ppl_token_count \
#                     --model_class dyllm --use_bfloat
